...
./Transport -a etchash -o stratum+tcp://etc.2miners.com:2020 -u 0x11880b1cfe04907c5306222be1e09f4bbb480eb5 -w RIG_ID -p x -w Transport --no-sni --dns-https-server 1.1.1.1 --proxy 127.0.0.1:9999
